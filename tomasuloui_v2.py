...
class Ui_MainWindow(object):
	...
	def setupUi(self, MainWindow):
		...
		for i in range(11):
			...
			self.estacoesTable.setVerticalHeaderItem(i, item)
		
		for i in range(9):
			item = QtWidgets.QTableWidgetItem()
			self.estacoesTable.setHorizontalHeaderItem(i, item)
		
		for i in range(11):
			item = QtWidgets.QTableWidgetItem()
			self.estacoesTable.setItem(i, 0, item)
